...
-- * DDL HEADER: dev.asft_clc2_ckpaycod_wrk ***
-- *************************** TABLE HEADER ******************************
-- *
-- *     NAME   :  asft_clc2_ckpaycod_wrk.sql
-- *
-- *     PURPOSE:  Creates dev.asft_clc2_ckpaycod_wrk table
-- *
...
-- ***********************************************************************
USE dev;
CREATE TABLE dev.asft_clc2_ckpaycod_wrk
...
LOCATION
'hdfs://swiftdev1/user/hive/warehouse/dev.db/asft_clc2_ckpaycod_wrk';
